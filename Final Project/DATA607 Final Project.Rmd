...
air_quality <- read.csv("https://raw.githubusercontent.com/javernw/DATA607GroupProjects/master/Final%20Project/Air_Quality.csv", header = T, stringsAsFactors = F) #Air_Quality.csv
...
#### Collect Neighborhood and Matching UHF42 Code from [.pdf](http://a816-dohbesp.nyc.gov/IndicatorPublic/EPHTPDF/uhf42.pdf) file on web
```{r}
